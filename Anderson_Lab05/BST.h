...
class BST : public BSTInterface
{
	...
	*/
	...
	BNode* doSearch(int entry, BNode* subtree) const;
	...
	*/
	...
	void doRemove(int entry, BNode* subtree);
	/**
	...
	*/
	...
	void doSpiralLevelOrder(BNode* subtree) const;
	/**
	...
	*/
	...
	void visitSpiralLevelOrder() const;
};
#endif
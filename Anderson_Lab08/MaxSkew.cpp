...
BNode* MaxSkew::concate(BNode* h1, BNode* h2)
{
    BNode* temp;
    if(h1 == nullptr)
	{
...
int MaxSkew::height(BNode* BNode)
{
    if(BNode == nullptr)
	{
        return 0;
...
void MaxSkew::printLevel(BNode* bnode, int level)
{
    if(bnode != nullptr)
	{
        if(level == 1)
